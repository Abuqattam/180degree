...
$(document).ready(function () {
	...
	if ($(window).width() <= 991) {
		$(".comp-vals").addClass('owl-carousel');
		$(".comp-vals").owlCarousel({
        nav: false,
        loop: true,
        navText: ["<i class='la la-angle-left'></i>", "<i class='la la-angle-right'></i>"],
        dots: true,
    ...
    $('.op-menu').click(function () {
        $('.mob-menu, .overlay-z').addClass('active');
    });

    $('.cl-menu').click(function () {
        $('.mob-menu, .overlay-z').removeClass('active');
    });
	...
	$('.sticky-steps ul li').on("click", function () {
        $(this).addClass('active').siblings().removeClass('active');
    });
	
	$(window).scroll(function () {
        if ($(this).scrollTop() > 205) {
            $('.sticky-steps').addClass('fixed');
        } else {
            $('.sticky-steps').removeClass('fixed');
        }
    });
